...
public class HBaseServletQuery3 extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		if (bannedWords.size() == 0) {
			InputStream bannedfile = HBaseServletQuery3.class.getResourceAsStream("/banned_words");
