...
public class ConnectionManager {
	...
	/*
	 * The DNS address of the sub-databases remember to contain '/' at the end
	 * of the address!
	 */
	private static final String DNS1 = "127.0.0.1";
	private static final String DNS2 = "127.0.0.1";
	...
	private static final String URL1 = "jdbc:mysql://" + DNS1 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
	private static final String URL2 = "jdbc:mysql://" + DNS2 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
	private static final String URL3 = "jdbc:mysql://" + DNS3 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
	private static final String URL4 = "jdbc:mysql://" + DNS4 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
	private static final String URL5 = "jdbc:mysql://" + DNS5 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
	private static final String URL6 = "jdbc:mysql://" + DNS6 + DB_NAME
			+ "?useSSL=false&useCursorFetch=true&defaultFenchSize=1000";
