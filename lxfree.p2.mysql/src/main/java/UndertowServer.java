...
import query2.MySqlServletQuery2;
import query3.MySqlServletQuery3;
		...
		try {
			DeploymentInfo servletBuilder = deployment().setClassLoader(UndertowServer.class.getClassLoader())
					...
					.addServlets(
							...
							servlet("MySqlServletQuery2", MySqlServletQuery2.class).addMapping("/q2"),
							servlet("MySqlServletQuery3", MySqlServletQuery3.class).addMapping("/q2")
					);
